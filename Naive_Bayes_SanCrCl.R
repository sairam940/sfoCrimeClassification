...
## Load data
train <- read.csv(file="Documents/R/Naive_Bayes_sanCrCl/train.csv",head=TRUE,sep=",")
test <- read.csv(file="Documents/R/Naive_Bayes_sanCrCl/test.csv",head=TRUE,sep=",")
